...
public class ParseCheckConstraintTest {
    ...
    public static void main(String[] args) throws Exception {
        // Create SqlExecuteService instance
        SqlExecuteService sqlExecuteService = new SqlExecuteService();
        
        // Get private method using reflection
        Method parseMethod = SqlExecuteService.class.getDeclaredMethod("parseCheckConstraint", String.class);
        parseMethod.setAccessible(true);
        
        // 1. Test regex constraint
        System.out.println("=== Test Regex Constraint ===");
        String regexConstraint1 = "CHECK (`STU_CODE` REGEXP '^\\d{10}$')";
        String regexResult1 = (String) parseMethod.invoke(sqlExecuteService, regexConstraint1);
        ...
        String regexResult2 = (String) parseMethod.invoke(sqlExecuteService, regexConstraint2);
        ...
        String betweenResult = (String) parseMethod.invoke(sqlExecuteService, betweenConstraint);
        ...
        String inResult = (String) parseMethod.invoke(sqlExecuteService, inConstraint);
