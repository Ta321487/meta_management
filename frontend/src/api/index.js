...
export const migrateFieldBatchToTable = (data) => request.post('/field/migrate/batch', data)
...
export const generateService = (tableCode, packageName, businessCode, useInterface) => request.get(`/codegen/service/${tableCode}`, { params: { packageName, businessCode, useInterface } })
export const generateServiceInterface = (tableCode, packageName, businessCode) => request.get(`/codegen/service-interface/${tableCode}`, { params: { packageName, businessCode } })
export const generateServiceImpl = (tableCode, packageName, businessCode) => request.get(`/codegen/service-impl/${tableCode}`, { params: { packageName, businessCode } })
